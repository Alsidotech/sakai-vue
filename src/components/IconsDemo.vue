<template>
  <div>
    <div class="card">
      ...
      <pre v-code>
        <code>&lt;i class="pi pi-check"&gt;&lt;/i&gt;</code>
      </pre>

      <i class="pi pi-check"></i>

      <pre v-code>
        <code>&lt;i class="pi pi-check" style="font-size: 2rem"&gt;&lt;/i&gt;</code>
      </pre>
      ...
      <pre v-code>
        <code>&lt;i class="pi pi-spin pi-spinner" style="font-size: 2rem"&gt;&lt;/i&gt;</code>
      </pre>
