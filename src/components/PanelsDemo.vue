      ...
      <div class="card">
        ...
        <Accordion :activeIndex="0">
          <AccordionTab header="Header I">
            <p class="line-height-3 m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
          ...
          <AccordionTab header="Header II">
            <p class="line-height-3 m-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
          ...
          <AccordionTab header="Header III">
            <p class="line-height-3 m-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
      ...
      <div class="card">
        ...
        <div class="grid">
          ...
          <div class="col-5 align-items-center justify-content-center">
            ...
            <p class="line-height-3 m-0">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus
              saepe eveniet ut et
          ...
          <Splitter style="height: 300px" class="mb-5">
            <SplitterPanel :size="40" :minSize="10" style="overflow: scroll">
              <p class="col m-3">
                ...
                nisi ipsum fuga numquam
                distinctio obcaecati quibusdam repellat, est assumenda quam perferendis reprehenderit, blanditiis,
                excepturi facilis! Voluptatem.
              </p>
            </SplitterPanel>
              ...
              <Splitter layout="vertical">
                ...
                <SplitterPanel :size="85">
                  <p class="col m-3">
                    ...
                    aut perferendis doloribus asperiores repellat. Donec vel volutpat ipsum. Integer nunc magna, posuere
                    ut tincidunt eget,
